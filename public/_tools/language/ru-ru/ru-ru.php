...
$_['tab_attachment']                = 'Прикрепленные файлы';
$_['tab_actions']                   = 'Действия';
...
$_['tab_google']                    = 'Google';
$_['tab_offer_attachment']          = 'Готовая работа';
...
$_['notification_new_offer'] = '%s разместил(а) новое предложение в заказе <a href="%s">%s</a>';
$_['notification_assign_offer'] = '%s принял(а) %s в заказе <a href="%s">%s</a>';
...
$_['notification_message_claim'] = 'Администратор оставил сообщение <a href="%s">%s</a>';
