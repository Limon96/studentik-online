           ...
           /* $support = array();
            ...
            if ($this->user->hasPermission('access', 'support/faq')) {
                $support[] = array(
                    ...
                    'href'     => $this->url->link('support/faq', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'support/message')) {
                $support[] = array(
                    'name'	   => $this->language->get('text_message'),
                    'href'     => $this->url->link('support/message', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($support) {
                $data['menus'][] = array(
                    ...
                    'name'	   => $this->language->get('text_menu_support'),
                    'href'     => '',
                    'children' => $support
                );
            }*/
            ...
            if ($this->user->hasPermission('access', 'claim/claim')) {
                $data['menus'][] = array(
                    ...
                    'name'	   => $this->language->get('text_claim'),
                    'href'     => $this->url->link('claim/claim', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'finance/blocked_cash')) {
                $data['menus'][] = array(
                    'id'       => 'menu-blocked_cash',
                    'icon'	   => 'fa-money',
                    'name'	   => $this->language->get('text_blocked_cash'),
                    'href'     => $this->url->link('finance/blocked_cash', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'message/message')) {
                $data['menus'][] = array(
                    'id'       => 'menu-message',
                    'icon'	   => 'fa-envelope',
                    'name'	   => $this->language->get('text_message'),
                    'href'     => $this->url->link('message/message', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'order/order_status')) {
                $order[] = array(
                    'name'	   => $this->language->get('text_order_status'),
                    'href'     => $this->url->link('order/order_status', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'order/work_type')) {
                $order[] = array(
                    'name'	   => $this->language->get('text_work_type'),
                    'href'     => $this->url->link('order/work_type', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'order/section')) {
                $order[] = array(
                    'name'	   => $this->language->get('text_section'),
                    'href'     => $this->url->link('order/section', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'order/subject')) {
                $order[] = array(
                    'name'	   => $this->language->get('text_subject'),
                    'href'     => $this->url->link('order/subject', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($order) {
                $data['menus'][] = array(
                    'id'       => 'menu-order',
                    'icon'	   => 'fa-question-circle',
                    'name'	   => $this->language->get('text_menu_order'),
                    'href'     => '',
                    'children' => $order
                );
            }
			...
			if ($this->user->hasPermission('access', 'customer/withdrawal')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_withdrawal'),
					'href'     => $this->url->link('customer/withdrawal', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
