...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['commission_customer'])) {
			$data['error_commission_customer'] = $this->error['commission_customer'];
		} else {
			$data['error_commission_customer'] = '';
		}
		...
		if (isset($this->request->post['config_commission_customer'])) {
			$data['config_commission_customer'] = $this->request->post['config_commission_customer'];
		} else {
			$data['config_commission_customer'] = $this->config->get('config_commission_customer');
		}
		...
		if (isset($this->request->post['config_payment_min'])) {
			$data['config_payment_min'] = $this->request->post['config_payment_min'];
		} elseif ($this->config->get('config_payment_min')) {
			$data['config_payment_min'] = $this->config->get('config_payment_min');
		} else {
			$data['config_payment_min'] = 100;
		}
		...
		if (isset($this->request->post['config_admin_customer_group_id'])) {
			$data['config_admin_customer_group_id'] = $this->request->post['config_admin_customer_group_id'];
		} else {
			$data['config_admin_customer_group_id'] = $this->config->get('config_admin_customer_group_id');
		}
		...
		if (isset($this->request->post['config_user_id'])) {
			$data['config_user_id'] = $this->request->post['config_user_id'];
		} else {
			$data['config_user_id'] = $this->config->get('config_user_id');
		}
		...
		if (isset($this->request->post['config_open_order_status_id'])) {
			$data['config_open_order_status_id'] = $this->request->post['config_open_order_status_id'];
		} else {
		...
		if (isset($this->request->post['config_pending_order_status_id'])) {
			$data['config_pending_order_status_id'] = $this->request->post['config_pending_order_status_id'];
		} else {
			$data['config_pending_order_status_id'] = $this->config->get('config_pending_order_status_id');
		}

		if (isset($this->request->post['config_progress_order_status_id'])) {
			$data['config_progress_order_status_id'] = $this->request->post['config_progress_order_status_id'];
		} else {
			$data['config_progress_order_status_id'] = $this->config->get('config_progress_order_status_id');
		}

		if (isset($this->request->post['config_awaiting_order_status_id'])) {
			$data['config_awaiting_order_status_id'] = $this->request->post['config_awaiting_order_status_id'];
		} else {
			$data['config_awaiting_order_status_id'] = $this->config->get('config_awaiting_order_status_id');
		}

		if (isset($this->request->post['config_verification_order_status_id'])) {
			$data['config_verification_order_status_id'] = $this->request->post['config_verification_order_status_id'];
		} else {
			$data['config_verification_order_status_id'] = $this->config->get('config_verification_order_status_id');
		}

		if (isset($this->request->post['config_revision_order_status_id'])) {
			$data['config_revision_order_status_id'] = $this->request->post['config_revision_order_status_id'];
		} else {
			$data['config_revision_order_status_id'] = $this->config->get('config_revision_order_status_id');
		}

		if (isset($this->request->post['config_complete_order_status_id'])) {
			$data['config_complete_order_status_id'] = $this->request->post['config_complete_order_status_id'];
		} else {
			$data['config_complete_order_status_id'] = $this->config->get('config_complete_order_status_id');
		}

		if (isset($this->request->post['config_canceled_order_status_id'])) {
			$data['config_canceled_order_status_id'] = $this->request->post['config_canceled_order_status_id'];
		} else {
		...
		if (isset($this->request->post['config_mail_smtp_sender_mail'])) {
			$data['config_mail_smtp_sender_mail'] = $this->request->post['config_mail_smtp_sender_mail'];
		} else {
			$data['config_mail_smtp_sender_mail'] = $this->config->get('config_mail_smtp_sender_mail');
		}
		...
		if (isset($this->request->post['config_mail_black_list'])) {
			$data['config_mail_black_list'] = $this->request->post['config_mail_black_list'];
		} elseif ($this->config->has('config_mail_black_list')) {
		   	$data['config_mail_black_list'] = $this->config->get('config_mail_black_list');
		} else {
			$data['config_mail_black_list'] = '';
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['config_commission']) {
			$this->error['commission'] = $this->language->get('error_commission');
		}

		if (!$this->request->post['config_commission_customer']) {
			$this->error['commission_customer'] = $this->language->get('error_commission_customer');
		}
