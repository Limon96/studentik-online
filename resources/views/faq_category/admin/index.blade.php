...
@section('content')
    ...
    <div class="sh-pagetitle">
        <div>
            <a href="{{ route('admin.faq_category.create') }}" class="btn btn-primary float-right">Создать</a>
        </div><!-- input-group -->
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.faq_category.edit', $item->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
                                        <form method="post" class="form-delete"
                                              action="{{ route('admin.faq_category.destroy', $item->id) }}">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit"
