...
@section('content')
    ...
    <div class="sh-breadcrumb">
        <nav class="breadcrumb">
            ...
            <span class="breadcrumb-item active">{{ __('FAQ') }}</span>
        </nav>
    </div><!-- sh-breadcrumb -->

    <div class="sh-pagetitle">
        <div>
            <a href="{{ route('admin.faq.create') }}" class="btn btn-primary float-right">Создать новую</a>
        </div><!-- input-group -->
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('faq.index') }}" class="btn btn-sm btn-info" target="_blank"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('admin.faq.edit', $item->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
